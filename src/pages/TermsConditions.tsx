  ...
  const sections = [
    {
      ...
      title: "Website Usage",
      desc:
        "By accessing this website, you agree to comply with all applicable laws, regulations and these terms and conditions.",
    },
    {
      icon: Scale,
      title: "Property Information",
      desc:
        "All property details, pricing, availability and specifications are subject to change without prior notice.",
    },
    {
      icon: Shield,
      title: "Investment Responsibility",
      desc:
        "Hosur All Property does not guarantee appreciation, investment returns or future market performance.",
    },
    {
      icon: AlertTriangle,
      title: "Third-Party Content",
      desc:
        "External links, maps or third-party resources provided on this website are for informational purposes only.",
    },
  ];
